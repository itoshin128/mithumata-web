    ...
    <div
      ...
      style={{
        ...
        backgroundImage: `
          ...
          radial-gradient(ellipse 1400px 1200px at 15% 10%, rgba(252, 248, 242, 0.55) 0%, transparent 45%),
          radial-gradient(ellipse 1200px 1400px at 85% 45%, rgba(250, 246, 238, 0.48) 0%, transparent 50%),
          radial-gradient(ellipse 1500px 1000px at 50% 85%, rgba(251, 247, 240, 0.52) 0%, transparent 45%),
          radial-gradient(ellipse 800px 900px at 25% 60%, rgba(252, 248, 243, 0.42) 0%, transparent 55%),
          linear-gradient(
            135deg,
            #fcfaf6 0%,
            #faf8f4 10%,
