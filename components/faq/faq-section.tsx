      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-5xl">
        ...
        <FadeInSection delay={0.1}>
          <div className="text-center mb-16 md:mb-20 lg:mb-24 max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-light mb-6 md:mb-8 tracking-[0.08em] leading-[1.6] text-balance">
              よくあるご質問
            </h2>
                  ...
                  <Accordion type="single" collapsible className="space-y-3 md:space-y-4">
                    {category.questions.map((item, questionIndex) => (
                      ...
                      >
                        <AccordionTrigger
                          className="
                            text-left font-serif font-light text-base md:text-lg
                        ...
                        <AccordionContent className="text-sm md:text-base lg:text-lg text-gray-700 leading-[1.8] tracking-[0.04em] font-serif font-light pt-4 md:pt-5 pb-2 text-pretty">
                          {item.a}
                        </AccordionContent>
                      </AccordionItem>
                    ))}
        ...
        <FadeInSection delay={0.5}>
          <div className="text-center mt-12 md:mt-16">
            <p className="text-base md:text-lg text-gray-700 mb-8 md:mb-10 font-serif font-light tracking-[0.04em] leading-[1.9]">
            ...
            <Link href="/contact">
              ...
              >
                ...
                <span className="text-sm md:text-base">お問い合わせ</span>
