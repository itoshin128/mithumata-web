    ...
    <FadeInSection delay={delay}>
      <Link href={post.href} className="block h-full">
        <article className="group h-full flex flex-col cursor-pointer">
          ...
          >
            <div className="relative aspect-[16/10] overflow-hidden shadow-lg rounded-xl sm:rounded-2xl">
              <Image
              ...
              <div className="absolute top-3 left-3 sm:top-4 sm:left-4 md:top-5 md:left-5">
                <span
                  className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-serif tracking-wider bg-white/95 backdrop-blur-sm shadow-md rounded-md"
          ...
          {/* Content */}
          <div className="flex-1 flex flex-col space-y-3 sm:space-y-4 px-2 sm:px-0">
            {/* Title */}
            <h3 className="text-lg sm:text-lg md:text-xl lg:text-xl font-serif font-light tracking-[0.05em] leading-[1.6] text-gray-900 text-balance group-hover:text-gray-600 transition-colors duration-300">
              {post.title}
            </h3>

            {/* Excerpt */}
            <p className="flex-1 text-sm sm:text-base md:text-base text-gray-700 leading-[1.9] tracking-[0.04em] font-serif font-light text-pretty line-clamp-3">
              {post.excerpt}
            </p>
            ...
            <div className="pt-2 sm:pt-3">
              <motion.span
                whileHover={{ x: 4 }}
                className="inline-flex items-center gap-2 text-sm sm:text-base font-serif font-light tracking-[0.12em] transition-colors duration-300"
                style={{ color: post.categoryColor }}
              >
                続きを読む
  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-32 lg:py-40">
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-9 md:gap-10 lg:gap-12 mb-10 sm:mb-12 md:mb-16">
          ...
          <div className="flex justify-center mt-10 sm:mt-12 md:mt-16">
            <Link href="/blog">
              <motion.button
                ...
                "
              >
                <BookOpen className="w-5 h-5 sm:w-5 sm:h-5 md:w-4 md:h-4" />
                <span className="text-base sm:text-base md:text-sm">すべての記事を見る</span>
